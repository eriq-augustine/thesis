...
\begin{itemize}
   ...
   \item The Cal Poly Computer Science Department for being the very supportive and helpful.
...
A decision tree is a simple data structure used to come to a conclusion based off of a number of observations.
