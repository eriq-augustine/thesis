...
Not all Netflix outages generates a signal on Twitter. Those that don't may
...
\begin{itemize}
   ...
   \item Design and implementation of the SPOONS distribution model.
...
not providing an upper limit includes new tweets outside of the original search scope. This can result in tweets
...
\label{arch-dist-requirements-performance}
...
\begin{itemize}
   ...
   \item[Scalability:] Scaling a SPOONS cluster should be trivial.
\end{itemize}

\paragraph{Usability}
\label{arch-dist-requirements-usability}
...
Each classifier will vary the type of filtering it uses between no filtering and full filtering (every method discussed in Section~\ref{class-filter}).
...
\begin{table}[H]
   \begin{center}
      \begin{tabular}{|l|l|}
         ...
         \tabularnewline\hline
            BayesNetClassifier & None
         \tabularnewline\hline
            BinaryBayesNetClassifier & Full
         \tabularnewline\hline
            BinaryJ48Classifier &
         \tabularnewline\hline
            BinaryKNNClassifier &
...
The results of the classification evaluation will be shown in confusion matrices.
Table~\ref{table:confusionExample} shows an example of a classification confusion matrix.
...
\begin{table}[H]
   \begin{center}
      ...
      \caption[Example Classification Confusion Matrix]{A example confusion matrix for a classifier.}
...
\begin{table}[H]
   \begin{center}
      \scalebox{0.65}{
         ...
         \hline
            neutral  & 0 & 3 & 11 & 2 & \textbf{16} & \textbf{7} & 7 & 0 & \textbf{20} \\
         \hline
            snafu    & 0 & 0 & 1 & 87 & 4 & 4 & 41 & 0 & 21 \\
         \hline
            watching & 0 & 2 & \textbf{12} & 3 & 88 & \textbf{5} & 4 & 0 & \textbf{21} \\
         \hline
            response & 0 & 2 & \textbf{5} & 4 & \textbf{7} & 0 & 3 & \textbf{1} & \textbf{8} \\
         \hline
            complaint& 0 & 2 & 5 & 40 & 4 & 1 & 68 & 1 & 25 \\
         \hline
            refuse to rate & 0 & 9 & \textbf{1} & 1 & \textbf{1} & \textbf{1} & 0 & 18 & \textbf{17} \\
         \hline
            happy    & 0 & 1 & \textbf{9} & 3 & \textbf{13} & \textbf{6} & 8 & 0 & 107 \\
         \hline
         \end{tabular}
      }
...
% TODO(eriq): Include the training set as an appendix.
