...
\subsection{Recall}
\label{outage-detection-metrics-recall}
...
\label{outage-detection-metrics-precision}
...
\label{outage-detection-metrics-f}
...
\subsection{Coverage}
\label{outage-detection-metrics-coverage}
F$_{0.5}$ score cannot completely capture the effectiveness of an outage detection method.
...
Also, every alert it generates (the single one) will intersect with a real outage which will produce a precision of 1.
...
The outage reports that Netflix provided has a coverage of 0.33.
